...
/// <summary>
/// Hide the original calling address of a function
/// 
/// We could spoof pointers by returning an object thats not actually a pointer
/// but has the type of one
/// </summary>
...
namespace Detail {
	...
	struct argument_remapper<Argc, std::enable_if<Argc <= 4>> {
		// 4 or less params
		template<
			typename Ret,
			typename First = void*,
